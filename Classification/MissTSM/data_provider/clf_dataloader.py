...
def data_generator(sourcedata_path, targetdata_path, configs, trial, training_mode, subset = True, fraction=''):
    
    if fraction != '':
        train_pt = "train_"+str(fraction)+ "_v" + str(trial) + ".pt"
        val_pt = "val_"+str(fraction)+"_v" + str(trial) + ".pt"
        test_pt = "test_"+str(fraction)+"_v" + str(trial) + ".pt"
    else:
        train_pt = "train.pt"
        val_pt = "val.pt"
        test_pt = "test.pt"
