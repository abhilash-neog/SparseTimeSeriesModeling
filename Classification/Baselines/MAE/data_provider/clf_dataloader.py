...
def data_generator(sourcedata_path, targetdata_path, configs, trial, imputation, training_mode, subset = True, fraction=''):
    ...
    if fraction != '':
        if imputation=="Spline":
            train_pt = "train_"+str(fraction)+"_spline_imputed" + "_v" + str(trial) + ".pt"
            val_pt = "val_"+str(fraction)+"_spline_imputed" + "_v" + str(trial) + ".pt"
            test_pt = "test_"+str(fraction)+"_spline_imputed" + "_v" + str(trial) + ".pt"
        else:   
