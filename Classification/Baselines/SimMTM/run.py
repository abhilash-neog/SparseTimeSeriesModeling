...
# parser.add_argument('--gt_root_path', type=str, default='./datasets', help='root path of the ground-truth file')
# parser.add_argument('--data_path', type=str, default='ETTh1.csv', help='data file')
# parser.add_argument('--gt_data_path', type=str, default='ETTh1.csv', help='gt data file')
# parser.add_argument('--features', type=str, default='M', help='forecasting task, options:[M, S, MS]; M:multivariate predict multivariate, S:univariate predict univariate, MS:multivariate predict univariate')
# parser.add_argument('--target', type=str, default='OT', help='target feature in S or MS task')
parser.add_argument('--freq', type=str, default='h', help='freq for time features encoding, options:[s:secondly, t:minutely, h:hourly, d:daily, b:business days, w:weekly, m:monthly], you can also use more detailed freq like 15min or 3h')
parser.add_argument('--trial', type=int, default=0)
parser.add_argument('--checkpoints', type=str, default='./finetune_checkpoints', help='location of model fine-tuning checkpoints')
parser.add_argument('--pretrain_checkpoints', type=str, default='./pretrain_checkpoints', help='location of model pre-training checkpoints')
...
parser.add_argument('--pretrain_dataset', default='SleepEEG', type=str, help='Dataset of choice: SleepEEG, FD_A, HAR, ECG')
parser.add_argument('--target_dataset', default='Epilepsy', type=str, help='Dataset of choice: Epilepsy, FD_B, Gesture, EMG')
...
parser.add_argument('--imputation', type=str, default='SAITS')
...
parser.add_argument('--devices', type=str, default='5,6,7', help='device ids of multile gpus')
...
if args.use_gpu and args.use_multi_gpu:
    ...
    print(f"List of device ids = {args.device_ids}")
elif args.use_gpu:
...
if args.task_name == 'pretrain':
    ...
    for ii in range(args.itr):
        ...
        args.load_checkpoints = os.path.join(args.pretrain_checkpoints, args.pretrain_dataset + "_v" + str(args.trial),  "ckpt_best_"+args.fraction+".pth")#args.transfer_checkpoints)
        ...
        total_loss, total_acc, total_auc, total_prc, trgs, performance = exp.test()
