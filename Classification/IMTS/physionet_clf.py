...
class ImputedDataLoader:
    def __init__(
        ...
        imputed_train_set = np.load("./train_X_imp.npy")
        imputed_val_set = np.load("./val_X_imp.npy")
        imputed_test_set = np.load("./test_X_imp.npy")

        train_set_labels = np.load("./train_y.npy")
        val_set_labels = np.load("./val_y.npy")
        test_set_labels = np.load("./test_y.npy")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--root_dir", default='.', type=str, help="model and log saving dir")
    parser.add_argument(
        "--original_dataset_path", default='.', type=str, help="path of original dataset"
    )
    parser.add_argument(
        "--imputed_dataset_path", default='.', type=str, help="path of imputed dataset"
    )
    ...
    parser.add_argument(
        "--device", type=str, default="cuda:7", help="device to run model"
    )
