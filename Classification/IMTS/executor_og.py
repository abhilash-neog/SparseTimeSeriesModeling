...
from trainer_og import Trainer
...
parser.add_argument('--pretrain_ckpt_name', type=str, default='ckpt_best_.pth', help='checkpoints we will use to finetune, options:[ckpt_best.pth, ckpt10.pth, ckpt20.pth...]')
