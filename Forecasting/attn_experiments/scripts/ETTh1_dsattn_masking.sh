...
PRETRAIN_CKPT_DIR="/raid/abhilash/RUNS/pretrain_checkpoints_ETTh1_dsattn/ckpt_${ENCODER_DIM}_${ENCODER_DEPTH}_${ENCODER_HEADS}_${DECODER_DIM}_${DECODER_DEPTH}_${DECODER_HEADS}_dropout_${DROPOUT}_${FC_DROPOUT}/"
FINETUNE_CKPT_DIR="/raid/abhilash/RUNS/finetune_checkpoints_ETTh1_dsattn/ckpt_${ENCODER_DIM}_${ENCODER_DEPTH}_${ENCODER_HEADS}_${DECODER_DIM}_${DECODER_DEPTH}_${DECODER_HEADS}_dropout_${DROPOUT}_${FC_DROPOUT}/"
