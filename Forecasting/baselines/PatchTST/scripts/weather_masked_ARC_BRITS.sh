...
OUTPUT_PATH="/projects/ml4science/time_series/PatchTST_supervised/outputs/BRITS/${MASKINGTYPE}/weather_v${TRIAL}/"

CHECKPOINT="/projects/ml4science/time_series/PatchTST_supervised/BRITS/checkpoints/"
