...
OUTPUT_PATH="/projects/ml4science/time_series/PatchTST_supervised/outputs/kNN/${MASKINGTYPE}/ETTh2_v${TRIAL}/"

CHECKPOINT="/projects/ml4science/time_series/PatchTST_supervised/kNN/checkpoints/"
...
data_path_name="v${TRIAL}_${MASKINGTYPE}_etth2_imputed_kNN.csv"
model_id_name=ETTh2
data_name=ETTh2
