...
if __name__ == '__main__':
    ...
    parser.add_argument('--d_model', type=int, default=32, help='dimension of TFI Embedding')
    parser.add_argument('--query_dim', type=int, default=512, help='dimension of the model')
