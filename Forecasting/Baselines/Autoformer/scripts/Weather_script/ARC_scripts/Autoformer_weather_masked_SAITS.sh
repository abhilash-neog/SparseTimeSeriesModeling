...
CHECKPOINT="/projects/ml4science/time_series/Autoformer/SAITS/checkpoints_upd/"
...
OUTPUT_PATH="/projects/ml4science/time_series/Autoformer/outputs_upd/SAITS/${MASKINGTYPE}/weather_v${TRIAL}/"
