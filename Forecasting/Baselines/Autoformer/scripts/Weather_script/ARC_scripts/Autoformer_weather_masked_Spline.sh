...
CHECKPOINT="/projects/ml4science/time_series/Autoformer/Spline/checkpoints/"
...
OUTPUT_PATH="/projects/ml4science/time_series/Autoformer/outputs/Spline/${MASKINGTYPE}/weather_v${TRIAL}/"
