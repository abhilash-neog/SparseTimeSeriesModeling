...
OUTPUT_PATH="/projects/ml4science/time_series/DLinear/outputs/SAITS/${MASKINGTYPE}/traffic_v${TRIAL}/"
=======
CHECKPOINT="./model_checkpoints/SAITS/"
OUTPUT_PATH="./outputs/SAITS/${MASKINGTYPE}/traffic_v${TRIAL}/"
>>>>>>> 0047644 (dlinear updates pandemic da)
