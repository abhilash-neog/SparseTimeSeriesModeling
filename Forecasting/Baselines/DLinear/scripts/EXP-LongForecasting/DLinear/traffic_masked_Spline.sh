...
GT_ROOT_PATH="./datasets/traffic/"
root_path_name="./synthetic_datasets/traffic/"
data_path_name="v${TRIAL}_${MASKINGTYPE}_traffic_imputed.csv"
CHECKPOINT="./model_checkpoints/Spline/"
OUTPUT_PATH="./outputs/Spline/${MASKINGTYPE}/traffic_v${TRIAL}/"
