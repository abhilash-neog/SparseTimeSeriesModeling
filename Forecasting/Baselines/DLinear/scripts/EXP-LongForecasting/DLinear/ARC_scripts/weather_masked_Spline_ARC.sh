...
CHECKPOINT="/projects/ml4science/time_series/DLinear/Spline/checkpoints_upd/"
...
OUTPUT_PATH="/projects/ml4science/time_series/DLinear/outputs_upd/Spline/${MASKINGTYPE}/weather_v${TRIAL}/"
