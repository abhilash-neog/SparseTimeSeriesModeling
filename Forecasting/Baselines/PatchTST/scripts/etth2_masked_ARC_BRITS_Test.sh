...
OUTPUT_PATH="/projects/ml4science/time_series/PatchTST_supervised/outputs__/BRITS/${MASKINGTYPE}/ETTh2_v${TRIAL}/"

CHECKPOINT="/projects/ml4science/time_series/PatchTST_supervised/BRITS/checkpoints__/"
