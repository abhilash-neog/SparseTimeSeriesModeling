...
root_path_name="/raid/abhilash/synthetic_datasets/ETTh1/"
data_path_name="v${TRIAL}_${MASKINGTYPE}_etth1.csv"

OUTPUT_PATH="./outputs_mask_fraction/${MASKINGTYPE}/ETTh1_v${TRIAL}/"
