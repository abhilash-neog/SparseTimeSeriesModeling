...
OUTPUT_PATH="/projects/ml4science/time_series/PatchTST_supervised/outputs_upd/LOCF/${MASKINGTYPE}/weather_v${TRIAL}/"

CHECKPOINT="/projects/ml4science/time_series/PatchTST_supervised/LOCF/checkpoints_upd/"
...
data_path_name="v${TRIAL}_${MASKINGTYPE}_weather_imputed_LOCF.csv"
