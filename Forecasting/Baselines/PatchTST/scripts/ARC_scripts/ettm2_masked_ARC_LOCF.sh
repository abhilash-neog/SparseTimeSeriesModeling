...
OUTPUT_PATH="/projects/ml4science/time_series/PatchTST_supervised/outputs_upd/LOCF/${MASKINGTYPE}/ETTm2_v${TRIAL}/"
...
data_path_name="v${TRIAL}_${MASKINGTYPE}_ettm2_imputed_LOCF.csv"
model_id_name=ETTm2
data_name=ETTm2
