...
parser.add_argument('--output_path', type=str, default=1, help='path to output files')
...
if args.task_name == 'pretrain':
    ...
    for ii in range(args.itr):
        ...
        args.load_checkpoints = os.path.join(args.pretrain_checkpoints, args.data + "_" + str(args.trial), "ckpt_best_"+args.root_path.split('/')[-1]+".pth")#args.transfer_checkpoints)
