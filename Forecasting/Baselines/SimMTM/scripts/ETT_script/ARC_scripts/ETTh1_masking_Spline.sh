...
BASE_PATH="/projects/ml4science/time_series/ts_synthetic_datasets/updated_synthetic_datasets/ETTh1/"
ROOT_PATHS=$1
DEVICES=$2
TRIAL=$3
MASKINGTYPE=$4
...
OUTPUT_PATH="/projects/ml4science/time_series/SimMTM/outputs_upd/Spline/${MASKINGTYPE}/ETTh1_v${TRIAL}/"
