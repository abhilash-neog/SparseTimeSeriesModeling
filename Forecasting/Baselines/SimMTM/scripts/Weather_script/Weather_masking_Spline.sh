...
PRETRAIN_CHECKPOINTS_DIR="/raid/abhilash/SimMTM/Spline/pretrain_checkpoints_upd/"
FINETUNE_CHECKPOINTS_DIR="/raid/abhilash/SimMTM/Spline/finetune_checkpoints_upd/"
