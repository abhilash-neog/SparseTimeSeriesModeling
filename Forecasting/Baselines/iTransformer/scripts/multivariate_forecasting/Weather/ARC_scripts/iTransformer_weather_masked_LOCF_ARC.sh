...
CHECKPOINT="/projects/ml4science/time_series/iTransformer/LOCF/checkpoints_upd/"
...
OUTPUT_PATH="/projects/ml4science/time_series/iTransformer/outputs_upd/LOCF/${MASKINGTYPE}/weather_v${TRIAL}/"
seq_len=336
