...
# model define
parser.add_argument('--encoder_embed_range', type=int, nargs='+', default=[4, 8, 16, 32, 64, 128], help='encoder embedding dimension in the feature space')
...
parser.add_argument('--decoder_embed_range', type=int, nargs='+', default=[4,8, 16, 32, 64, 128], help='decoder embedding dimension in the feature space')
