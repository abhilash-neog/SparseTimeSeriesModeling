...
OUTPUT_PATH="./outputs/${MASKINGTYPE}/ENC_FRZN_ETTh1_v${TRIAL}_${ENCODER_DIM}_${ENCODER_DEPTH}_${ENCODER_HEADS}_${DECODER_DIM}_${DECODER_DEPTH}_${DECODER_HEADS}_dropout_${DROPOUT}_${FC_DROPOUT}/"
PRETRAIN_CKPT_DIR="/raid/abhilash/RUNS/pretrain_checkpoints_ETTh1/ENC_FRZN_ckpt_${ENCODER_DIM}_${ENCODER_DEPTH}_${ENCODER_HEADS}_${DECODER_DIM}_${DECODER_DEPTH}_${DECODER_HEADS}_dropout_${DROPOUT}_${FC_DROPOUT}/"
FINETUNE_CKPT_DIR="/raid/abhilash/RUNS/finetune_checkpoints_ETTh1/ENC_FRZN_ckpt_${ENCODER_DIM}_${ENCODER_DEPTH}_${ENCODER_HEADS}_${DECODER_DIM}_${DECODER_DEPTH}_${DECODER_HEADS}_dropout_${DROPOUT}_${FC_DROPOUT}/"
